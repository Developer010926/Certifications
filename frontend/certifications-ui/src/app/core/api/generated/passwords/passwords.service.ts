...
import type { PasswordDto } from '../certificationsApiV1.schemas';
...
export class PasswordsService {
  ...
  /**
   * @summary Reveal the current employee's password
   */
  revealOwnPassword<TData = PasswordDto>(options?: HttpClientBodyOptions): Observable<TData>;
  revealOwnPassword<TData = PasswordDto>(
  ...
  revealOwnPassword<TData = PasswordDto>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(`/api/v1/me/password/reveal`, undefined, {
